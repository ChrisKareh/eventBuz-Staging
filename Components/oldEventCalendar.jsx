...
const Scheduler = () => {
  ...
  const scheduleAPI = () => {
    ...
    let config = {
      ...
      url: 'https://jonathana74.sg-host.com/event-buz-backend-main/api/v1/event-schedule',
      headers: { 
  ...
  const deleteScheduleAPI = (event) => {
    ...
    let config = {
      method: 'GET',
      maxBodyLength: Infinity,
      url: `https://jonathana74.sg-host.com/event-buz-backend-main/api/v1/event-schedule/${createEvent_ID}/${scheduleID}`,
      headers: { 
        'Content-Type': 'application/json', 
        'Authorization': 'Bearer 51|NEv7YHB9Sylk3jwuLbKbzeSbH6KwfcjnmZ3rZw8A410046bf', 
  ...
  const editScheduleAPi = (event) => {
    ...
    let config = {
      method: 'POST',
      maxBodyLength: Infinity,
      url: `https://jonathana74.sg-host.com/event-buz-backend-main/api/v1/event-schedule/${scheduleID}`,
      headers: { 
        'Content-Type': 'application/json', 
        'Authorization': 'Bearer 51|NEv7YHB9Sylk3jwuLbKbzeSbH6KwfcjnmZ3rZw8A410046bf', 
  ...
  useEffect(() => {
    ...
    async function initScheduler() {
      ...
      // dhxScheduler.load('https://jonathana74.sg-host.com/event-buz-backend-main/api/v1/event-schedule', 'json');
